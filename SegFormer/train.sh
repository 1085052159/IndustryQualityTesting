...
#config="local_configs/segformer/B0/segformer.b0.256x256.bolt_line.30k.py"
#config="local_configs/segformer/B1/segformer.b1.256x256.bolt_line.30k.py"
#config="local_configs/segformer/B1/segformer.b1.256x256.bolt_line.80k.py"
config="local_configs/segformer/B0/segformer.b0.256x256.bolt_line.80k.py"
