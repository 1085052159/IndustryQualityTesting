...
def recog_img_reading(abso_img_paths, save_path, kernel_size=1, device="cuda", show_temp=False):
    ...
    ckpt_det_piezometer = "./yolov5/runs/train/piezometer/weights/best.pt"
    ckpt_det_panel_mark = "./yolov5/runs/train/piezometer_panel/weights/best.pt"
    config_seg_pointer = "./SegFormer/work_dirs/segformer.b0.256x256.pointer.160k/segformer.b0.256x256.pointer.160k.py"
    ckpt_seg_pointer = "./SegFormer/work_dirs/segformer.b0.256x256.pointer.160k/iter_4000.pth"
