...
def parse_opt(known=False):
    ...
    # parser.add_argument('--data', type=str, default='data/bolt.yaml', help='dataset.yaml path')
    parser.add_argument('--data', type=str, default='data/piezometer_multi_cls.yaml', help='dataset.yaml path')
...
def main(opt):
    ...
    if opt.resume and not wandb_run:  # resume an interrupted run
        ...
        with open(Path(ckpt).parent.parent / 'opt.yaml') as f:
            opt = argparse.Namespace(**yaml.rsafe_load(f))  # replace
